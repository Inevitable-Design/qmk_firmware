...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [WIN_FN] = LAYOUT_ansi(
		...
		_______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, RM_TOGG, RM_NEXT, _______, _______,
		DF(2),   KC_BT1,  KC_BT2,  KC_BT3,  KC_2G4,  KC_USB,  _______, RM_SATD, RM_SATU, _______, _______, _______, _______, _______, RM_HUEU, _______, _______,
		_______, _______, KC_SNAKE,_______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
		_______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          _______,          RM_VALU,
		_______, GU_TOGG, _______, _______,                   KC_BAT,                    _______, _______, _______, _______, _______, RM_SPDD, RM_VALD, RM_SPDU
    ),
    ...
    [MAC_FN] = LAYOUT_ansi(
		...
		_______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, RM_TOGG, RM_NEXT, _______, _______,
		DF(0),   KC_BT1,  KC_BT2,  KC_BT3,  KC_2G4,  KC_USB,  _______, RM_SATD, RM_SATU, _______, _______, _______, _______, _______, RM_HUEU, _______, _______,
		_______, _______, KC_SNAKE,_______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
		_______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          _______,          RM_VALU,
		_______, _______, _______, _______,                   KC_BAT,                    _______, _______, _______, _______, _______, RM_SPDD, RM_VALD, RM_SPDU
    )
};
// clang-format on
